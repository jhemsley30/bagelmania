...
<div id="content">
        ...
        <a href='http://oc.cityvoter.com/bagelmania/biz/79770' target='_blank'>
		<img class='fade-title' src='http://setdesign-la.com/bagelmania-images/fade-title.png'/></a>
			
	<!-- ------ SLIDESHOW -------------------------------------------- -->		
		 <div id="slideshow">
		   
			<img src="http://setdesign-la.com/bagelmania-images/marissaZajack.jpg" alt="Slideshow Image 1" class="active" />
			<!-- <img src="http://setdesign-la.com/bagelmania-images/marissaZajack2.jpg" alt="Slideshow Image 2" /> -->
			<!-- <img src="http://setdesign-la.com/bagelmania-images/marissaZajack3.jpg" alt="Slideshow Image 3" /> -->
			<!-- <img src="http://setdesign-la.com/bagelmania-images/marissaZajack4.jpg" alt="Slideshow Image 4" /> -->
		</div>	
         <h3 class='home'>Please click on the image thumbnails on the right to enlarge</h3>	
	
		</article> <!-- /.post -->
	<!------- JH this section is used for special section, edit info in Home page (in interface)  -->	
		<article class="post clearfix">	
	...
	<!---------   END of special section for home page ------------------------------------------------------>
	
	<!--------   ###### FACEBOOK WIDGET -------------------------------------------->
		<article class="post clearfix homefacebook facebookWidget">	
	   ...
	   <p class='face'>Compare notes with all your friends. Who has the best bagels and coffee?</p>
...
<div class='widgetBorder'></div>
		...
		<section class="widgetLast clearfix">
		<h4 class="widgettitle">Original Banner</h4><br/>
			<img src='http://www.setdesign-la.com/bagelmania-images/Bagelmania-side-banner.jpg' />
		</section>
		...
		<!-- <div class='widgetBorder'></div> -->
		 ...
		 <div class='double'>
			<div class='location'>
				...
				<!-- <p>**All Bagelmania stores are indepently owned and operated. -->
			</div>
			<div class='pdfBottom'> 
