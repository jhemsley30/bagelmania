 <div id='headerContainer'>
	...
	<header id="header" class='clearfix'>
         <img class='coffee' src='http://setdesign-la.com/bagelmania-images/BMmug.png'/>
		<hgroup>
...
<div id="pagewrap">
   ...
   <p class='phoneNumber'>Call your order in now! 
                          We <span style='color:red;'>&hearts;</span> phone orders!!...............<span>(714) 965-5637</span></p>
...
<div id="content">
		...
		<article class="post clearfix jamesLogin">
...
<input type="submit" id="edit-submit" name="op" value="Log in" class="form-submit" /></div></div></form>
	...
	<div id='put-here'><a href='enter-here'>
	       <img class ='enter-here' src='http://setdesign-la.com/bagelmania-images/enter-here2.png'/></a>
	    </div>
